...
def main():
    ...
    parser.add_argument('-c', '--config', type=str, help="File path to the config file")
    parser.add_argument('-w', '--weight', type=str, help="File path to the weights")
    parser.add_argument('-o', '--output', type=str, default="yolo.onnx", help="Name of the onnx")
