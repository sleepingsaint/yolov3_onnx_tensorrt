...
LABEL_FILE_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'custom_labels.txt')
...
class PreprocessYOLO(object):
    ...
    def process_image(self, input_image):    
        image_raw, image_resized = self._load_and_resize_image(input_image)
        image_preprocessed = self._shuffle_and_normalize(image_resized)
        return image_raw, image_preprocessed
